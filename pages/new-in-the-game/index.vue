    ...
    <div class="d-none d-md-block">
      <b-breadcrumb>
        ...
        <b-breadcrumb-item class="cap" active to=""
          >New In The Game</b-breadcrumb-item
        >
      </b-breadcrumb>
    </div>
    <div class="row mt-3 mt-md-5">
      <div class="col-12 mt-3 mt-md-0">
        ...
        <div v-if="!$fetchState.pending">
          <div class="row">
            <div class="col-12">
              <h1 class="h2 font-weight-bold mb-5">New in the game 🌟</h1>
            </div>
          </div>
...
export default {
  ...
  async fetch() {
    ...
    const products = await this.$axios.get(
      `/qa/v2/public/hub-product/new-in-the-game?serviceAreaId=${this.serviceArea}&descending=true&statuses=IN_STOCK&status=OUT_OF_STOCK`
    );
    ...
    async loadMoreProducts() {
      ...
      if (this.currentPage <= this.totalPages) {
        const moreProducts = await this.$axios({
          mode: "cors",
          method: "get",
          url: `/qa/v2/public/hub-product/new-in-the-game?serviceAreaId=${this.serviceArea}&descending=true&statuses=IN_STOCK&statuses=OUT_OF_STOCK&pageNumber=${this.currentPage}`,
          headers: {
